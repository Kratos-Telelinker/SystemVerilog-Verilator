...
void Vtinyalu___024root___ctor_var_reset(Vtinyalu___024root* vlSelf);

Vtinyalu___024root::Vtinyalu___024root(Vtinyalu__Syms* symsp, const char* namep)
 {
    vlSymsp = symsp;
    vlNamep = strdup(namep);
    // Reset structure values
    Vtinyalu___024root___ctor_var_reset(this);
}

void Vtinyalu___024root___configure_coverage(Vtinyalu___024root* vlSelf, bool first);

void Vtinyalu___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtinyalu___024root___configure_coverage(this, first);
}

Vtinyalu___024root::~Vtinyalu___024root() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void Vtinyalu___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void Vtinyalu___024root::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
